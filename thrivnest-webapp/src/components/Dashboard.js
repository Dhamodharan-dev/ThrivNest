...
function Dashboard({ username, handleLogout, loggedIn, properties, handleEditProperty, handleDeleteProperty }) {
  ...
  }, [loggedIn, navigate]); // Include loggedIn and navigate in the dependencies array
              ...
              property.username === username ? (
                <div key={property._id} className='prop-items'>
                  <div className='prop-img-div'>
                    {property.image && 
                    <img src={`http://localhost:5000/${property.image}`} alt='Property' className='prop-img' />}
                  </div>
